...
public class MultiProfileSample {
    public MultiProfileSample(){
        ...
        var newerId = newerVM.Id;
        var newerProvisioningState = newerVM.ProvisioningState;
        var newerLicenseType = newerVM.LicenseType;
        var newerName = newerVM.Name;
        ...
        vm = profile_2017_01_31.Compute.VirtualMachines.Create("licenseType", newPlan);
        var id = vm.Id;
